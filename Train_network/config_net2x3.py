...
def get_config():
    ...
    # [FIX] THÊM DÒNG NÀY ĐỂ SỬA LỖI ATTRIBUTE ERROR
    parser.add_argument("--use_wandb", action='store_true', 
                        default=False, help="[for wandb usage], by default True, will log date to wandb server. or else will use tensorboard to log data.")
